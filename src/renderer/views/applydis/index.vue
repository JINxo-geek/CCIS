...
<el-col :span="24">
<ul id="v-for-object">
  <li v-for="value in log">
    在{{ value.disttime }}时发生调配，由{{ value.from }}号实验移动到{{value.to}}号实验室。
  </li>
</ul>
...
<el-row>
 ...
 <el-tag v-else type="danger">该药品已注销</el-tag>
  ...
  <div slot="footer" class="dialog-footer">
     <el-button @click="opLog();innerVisible = true">操作日志</el-button>
...
<!--      <el-table-column
    ...
    <el-button @click="disthandleClick2(scope.row)" type="primary" size="small">详细</el-button>
      <el-button @click="disthandleClick3(scope.row)" type="success" round size="small">申请</el-button>
        </template>
    </el-table-column>
    </el-table>
