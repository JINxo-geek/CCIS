...
<!--    <el-form-item style="margin-left:200px" label="条形码" prop="cas"> -->
   ...
   <el-form-item label="化学品名" prop="name">
    ...
    <el-input v-model="search.barcode" placeholder="请输入条形码" style="width:13vw"></el-input>
     ...
     <el-select disabled v-model="search.repo" placeholder="请选择" style="width:10vw">
    <el-option
...
<el-dialog title="调配" :visible.sync="distribute" width='400px'>
  ...
  <el-form :model="dist">
    <el-form-item label="调到的实验室编号">
      <el-input type="number" v-model.number="dist.name" auto-complete="off"></el-input>
    </el-form-item>
    <el-form-item label="数量">
<el-input type="number" v-model.number="dist.number" auto-complete="off"></el-input>
    </el-form-item>
  </el-form>
  ...
  <el-table :data="tableDataEnd"  border style="width: 100%" v-loading="searchloading">
